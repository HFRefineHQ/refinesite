      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-6">
          ...
          <a href="#value">
            <button
              type="button"
              className="px-8 py-4 border border-foreground/20 text-foreground rounded-lg font-semibold hover:border-primary hover:bg-primary/5 transition-all text-base sm:text-lg"
            >
              Learn More
            </button>
          </a>
